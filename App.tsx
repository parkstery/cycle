...
const App: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-slate-900 overflow-hidden font-sans">
      ...
      {route && (
        <div className={`absolute bottom-[25px] z-[50] flex items-end justify-end transition-all duration-300 ease-out ${elevationExpanded ? 'right-4 w-[80%] max-w-[288px]' : 'right-16 w-12 h-12 group'}`}>
