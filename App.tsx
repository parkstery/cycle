    ...
    <div className="fixed inset-0 bg-slate-900 overflow-hidden font-sans">
      ...
      {showClickTwoPointsHint && (
        <div className="absolute inset-0 z-[16] flex items-center justify-center pointer-events-none">
          <div className="bg-white border border-slate-200 px-6 py-4 rounded-2xl shadow-xl animate-in fade-in duration-300 origin-center" style={{ transform: 'scaleY(0.85)' }}>
      ...
      {mapRevealed && (
        <a
          ...
          className="absolute right-0 z-[26] text-[11px] text-slate-600 hover:underline bg-white/50 mr-[5px]"
          style={{ bottom: '10px' }}
        >
      ...
      {route && (
        <div className={`absolute bottom-[25px] z-[50] flex items-end justify-end transition-all duration-300 ease-out ${elevationExpanded ? 'right-4 w-[65%] max-w-[288px]' : 'right-16 w-12 h-12 group'}`}>
