...
function getLatLng(p: { lat?: number; lng?: number; lat?: () => number; lng?: () => number }): { lat: number; lng: number } {
...
export function computeDistanceBetween(a: { lat?: number; lng?: number; lat?: () => number; lng?: () => number }, b: { lat?: number; lng?: number; lat?: () => number; lng?: () => number }): number {
