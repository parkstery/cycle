    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {isList ? (
            <ul className="py-2 text-slate-800 list-none ps-0">
              <li>
                <button
              ...
              <li className="ps-4 pe-4 py-1.5 pt-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">
                Guide
              </li>
              <li>
                <ul className="border-s-2 border-slate-200 ms-4 ps-6 my-0.5 list-none">
                  <li>
                    <button
